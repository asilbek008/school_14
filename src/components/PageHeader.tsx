...
/** Dark page banner: breadcrumbs (the pages above this one), an optional kicker, title and intro. */
export default function PageHeader({ title, intro, kicker, crumbs }: { title: string; intro?: string; kicker?: string; crumbs?: Crumb[] }) {
  return (
