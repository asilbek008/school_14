...
const links = ["about", "timetable", "staff", "news", "events", "programs", "achievements", "tests", "library", "gallery", "schedule", "calendar", "clubs", "faq", "documents", "contact", "trust", "search"] as const;
