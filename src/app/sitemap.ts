...
const pages = ["", "/about", "/admissions", "/timetable", "/schedule", "/calendar", "/staff", "/news", "/events", "/programs", "/achievements", "/tests", "/tests/dtm", "/library", "/alumni", "/clubs", "/gallery", "/faq", "/documents", "/contact"];
